...
- [Architecture](architecture.md) — Five entry points (hook, CommandRouter, preview-dashboard, render, tray), timer interactions, field preservation, and state file lifecycle
...
## Log
Last updated: 2026-04-26 | 18 pages | ingest boundary 9 (overlay-dashboard-context step 08): added display-item-vs-session-identity.md and hookaccumulationstore-apply-from-fsw.md
